...
namespace EESpeak
{
	public partial class MainForm : Form
	{
		...
		SpeechSynthesizer speechEngine;
		bool speechEnabled = false;
		bool verboseSpeech = false;
		bool sayMetricPrefixes = false;
		...
		string enableSpeechCommand = "Enable speech";
		string disableSpeechCommand = "Disable speech";
		string[] toggleMetricPrefixes = { "Metric Prefixes On", "Metric Prefixes Off" };
		string[] fourBandStrings = { "Four band lookup", "Four band resistor", "Four band inductor", "Four band capacitor" };
		string[] fiveBandStrings = { "Five band lookup", "Five band resistor", "Five band inductor", "Five band capacitor" };
		string[] eiaCommandStrings = { "EIA lookup", "EIA", "EIA resistor", "EIA capacitor", "EIA inductor" };

		// Code numbers
		string[] numberString = { "zero", "one", "two", "three", "four", "five", "six", "seven", "eight", "nine" };

		// Resistor color wildcards
		string[] resistorColors = {"black", "brown", "red", "orange", "yellow", "green", "blue", "violet", "purple", "gray", "white", "gold", "silver", "none"};
		int[] resistorDigits = { 0, 1, 2, 3, 4, 5, 6, 7, 7, 8, 9, -1, -2, 0 };
		string[] resistorTolerances = { "20", "1", "2", "3", "4", "0.5", "0.25", "0.1", "0.1", "0.05", "", "5", "10", "20" };
		// Exit command
		string[] exitStrings = { "Exit EE Speak"};

		// EIA wildcards
		string[] eiaNumbers = { "zero", "one", "two", "three", "four", "five",
							"six", "seven", "eight", "nine" };

		string[] eiaLetters = { "Z", "Y", "R", "X", "S", "A", "B", "H", "C", "D", "E", "F" };
		string[] eiaPhonemes = { "Zulu", "Yankee", "Romeo", "X-ray", "Sierra", "Alfa", "Bravo", "Henry", "Charlie", "Delta", "Echo", "Foxtrot" };
